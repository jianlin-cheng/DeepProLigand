"""
#################################################################
#Algorithm 1 of the paper. Averages predicted structure and reference structure for cryo-EM map 22898.
...
def get_residues(pdb_file, output_dir):
    ...
    with open(file_path, 'w') as fi:
        ...
        fi.write('AVERAGE OF SUPERIMPOSED 22898')
        fi.write('\n')
        fi.write('AUTHOR')
        fi.write('\t')
        fi.write('UM BML')
    ...
    start_D1 = pose.conformation().chain_begin(8)
    end_D1 = pose.conformation().chain_end(8)

    start_D2 = pose.conformation().chain_begin(9)
    end_D2 = pose.conformation().chain_end(9)
    ...
    print(f"Number of residues averaged for Chain B : ", count_avg_B)
    ...
    print(f"Model-2: Reference structure residue difference of D is {end_D2 - start_D2}")
...
if __name__ == "__main__":
    pdb_file = '/data/22898_superimposed.pdb'
